...
public class TasksConnector {
    public static final String URL = "jdbc:sqlite:C:\\Users\\nanda\\Desktop\\Ananda\\FATEC\\Programação Orientada a Objetos\\BD\\tasks.db";
    ...
    public static void insertTasks(String name) throws Exception {
        Class.forName("org.sqlite.JDBC");
        Connection con = DriverManager.getConnection(URL);
        Statement stmt = con.createStatement();
    ...
    public static void deleteTasks(String name) throws Exception {
        Class.forName("org.sqlite.JDBC");
        Connection con = DriverManager.getConnection(URL);
        Statement stmt = con.createStatement();
