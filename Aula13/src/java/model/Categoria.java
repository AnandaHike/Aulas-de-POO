...
public class Categoria {
    ...
    public static void inserirCategoria(String nome, String descricao)throws Exception{
        Connection con = DbListener.getConnection();
        PreparedStatement stmt = con.prepareStatement("INSERT INTO categorias(nome, descricao) VALUES(?,?)");
    ...
    public static void alterarCategoria(String nome, String novoNome, String descricao)throws Exception{
        Connection con = DbListener.getConnection();
        PreparedStatement stmt = con.prepareStatement("UPDATE categorias SET nome=?, descricao=? WHERE nome=?");
    ...
    public static void excluirCategoria(String nome)throws Exception{
        Connection con = DbListener.getConnection();
        PreparedStatement stmt = con.prepareStatement("DELETE FROM categorias WHERE nome= ?");
        stmt.setString(1, nome);
        stmt.execute();
        stmt.close();
        con.close();
