<%-- 
    Document   : home
    Created on : 7 de set de 2020, 17:38:56
    Author     : nanda
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <p>Através da entrada de dados fornecidos pelo usuário será gerada uma tabela que mostrará as seguintes informações: </p>
